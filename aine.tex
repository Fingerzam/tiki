...
\abstract{Olkoon $n$ tietokonetta asetettu sykliin siten, että jokainen voi
    ...
    solmulla ei saa olla samaa väriä. Linial~\cite{linial92} on todistanut,
    että tällöin hajautettu algoritmi, joka haluaa värittää syklin solmut
    kolmella värillä käyttää tähän vähintään $\Omega(\log^* n)$
...
\begin{maar}
    Suunnatulla kaarella $e = (u,v) \in E$ on \emph{kärki}
    %
    \begin{equation*}
        \head(e) = v
    \end{equation*}
