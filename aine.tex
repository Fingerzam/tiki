...
\begin{center}
    \begin{tikzpicture}
        \graph[nodes={draw,circle, minimum size=7.5mm}, no placement] {
            1[x=0,y=0];
            2[x=0,y=1];
            3[x=0,y=2, very thick];
            4[x=1,y=1, very thick];
            5[x=2,y=2];
            6[x=3,y=1, very thick];
            7[x=2,y=0, very thick];
            8[x=3.5,y=2, very thick];
            9[x=4.5,y=2, very thick];
            10[x=4,y=0];
            11[x=5,y=1];

            {1,2} -- 4 -- 5 -- 6 --[very thick] 7;
            3 --[very thick] 4;
            3 -- 5;
            7 --[very thick] 4;
            6 --[very thick] 8 --[very thick] 9 -- 10 -- 11;
            6 -- 9 -- 11;
            6 -- 10;
        }
    \end{tikzpicture}
