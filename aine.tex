...
\begin{maar}
    Lukujoukosta $\set{1, \dots, k}$ käytetään seuraavaa lyhyempää merkintää:
    %
    \begin{equation*}
        [k] = \set{1, \dots, k}
    \end{equation*}
...
\begin{maar}
    ...
    V \to \set{1,\dots,k}$ jollain luonnollisella luvulla $k \in \nat$.
...
TODO: Määrittele $k$-ympäristö

TODO: kuvia naapurustoista eri säteillä
...
TODO: havainnollista kuvalla syklin naapurisolmujen näkymiä ja naapurustoverkon
vastaavia solmuja
...
naapurustoverkossa $\Btn$ on solmuina kaikki mahdolliset $t$-naapurustot.
